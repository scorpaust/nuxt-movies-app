import { getCurrentInstance, version, inject, ref, watchEffect, watch, toRef, createApp, reactive, markRaw, effectScope, isRef, isReactive, toRaw, unref, useSSRContext, getCurrentScope, onScopeDispose, nextTick, provide, onErrorCaptured, onServerPrefetch, toRefs, computed, shallowRef, isReadonly, defineAsyncComponent, withCtx, createVNode, defineComponent, h, Suspense, Transition } from 'vue';
...
import { a as useRuntimeConfig$1 } from './netlify.mjs';
...
const _routes = [
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "admin",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/admin",
    meta: __nuxt_page_meta$1 || {},
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./admin-0abba45d.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-24f40360.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./login-84f27cdd.mjs').then((m) => m.default || m)
  },
  {
    name: "movies-id",
    path: "/movies/:id",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_id_-859de66e.mjs').then((m) => m.default || m)
  },
  {
    name: "movies",
    path: "/movies",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-81b78690.mjs').then((m) => m.default || m)
  },
  {
    name: "teams-teamSlug-users-userId",
    path: "/teams/:teamSlug/users/:userId",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_userId_-e99891fa.mjs').then((m) => m.default || m)
  }
];
...
const logger_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
  console.log(to, from);
});
...
const layouts = {
  default: () => import('./default-ecb22871.mjs').then((m) => m.default || m),
  plain: () => import('./plain-50e68011.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-bcd2a2cf.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-43f34c46.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useRequestFetch as a, useRoute as b, createError as c, useHead as d, entry$1 as default, useRuntimeConfig as e, defineNuxtRouteMiddleware as f, defineStore as g, useRouter as h, navigateTo as n, showError as s, useNuxtApp as u };
